...
$(document).ready(function(){
   ...
   $("#addalb").click(function() {
    ...
    $('body').on('click', '#fade', function(){
        $('#fade,#newalb').fadeOut('slow')
    });

});

$(document).ready(function(){
   $(".albumlight").click(function() {

		 var albID = $(this).data('rel'); //Trouver la pop-up correspondantev
        $("body").append('<div id="fade3"></div>');
        $('#fade3').css({'filter' : 'alpha(opacity=80)'}).fadeIn();
        $("#" + albID).css({'filter' : 'alpha(opacity=100)'}).fadeIn();
    });

    $('#return').on('click', function(){
        $(".galAlbum").fadeOut('slow');
    });
...
$(document).ready(function(){
   $('.ajoutalbum').click(function() {
		 var alblistID = $(this).data('rel');
        $("body").append('<div id="fade3"></div>');
        $('#fade3').css({'filter' : 'alpha(opacity=80)'}).fadeIn();
        $("#" + alblistID).css({'filter' : 'alpha(opacity=100)'}).fadeIn();
    });

			$('.closeem').on('click', function(){
					$(".albumlisto").fadeOut('slow');
			});
});

$(document).ready(function(){
   $('.exifbut').click(function() {
		 	var exifID = $(this).data('rel');
        $("body").append('<div id="fade3"></div>');
        $('#fade3').css({'filter' : 'alpha(opacity=80)'}).fadeIn();
        $("#" + exifID).css({'filter' : 'alpha(opacity=100)'}).fadeIn();
    });

			$('.closeExif').on('click', function(){
					$(".exif").fadeOut('slow');
			});
});
